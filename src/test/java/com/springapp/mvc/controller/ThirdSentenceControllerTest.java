 ...
 */
public class ThirdSentenceControllerTest {
    private PoemService poemService;
    private ThirdSentenceController controller;
    ...
    public void setUp() throws Exception {
        ...
        controller = new ThirdSentenceController(poemService);
    ...
    public void testOnPage() throws Exception {
        ...
        assertThat(modelAndView).isEqualTo("third");
    }
